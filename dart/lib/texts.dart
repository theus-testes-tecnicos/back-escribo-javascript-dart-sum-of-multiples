...
List<String> instructions = [
  ...
  colorText("==========================================================", 36),
  colorText("", 36),
  colorText("Vamos começar?", 37),
];

List<String> response(String value, List<int> multiples, int result) {
  return [
    colorText("", 32),
    colorText("======================================================", 32),
    colorText("Muito bem!", 32),
    colorText('Foi calculado aqui que os números que são abaixo de $value', 32),
    colorText('e que são divisiveis por 3 ou 5 são:', 32),
    colorText("", 32),
    colorText('{${multiples.join(", ")}}.', 33),
    colorText("", 32),
    colorText(
        'E o resultado da soma destes números é: ${colorText(result.toString(), 33)}.',
        32),
    colorText("======================================================", 32),
    colorText("", 32),

# Soma dos Múltiplos [Typescript]

Projeto console para o teste técnico da empresa Escribo, escrito em Node.JS com tipagem estática (Typescript)
...
* Instale as dependências:
     ...
     npm install
     ```
* Execute a aplicação de dentro da pasta typescript:
     ```bash
     npm run start
     ```
